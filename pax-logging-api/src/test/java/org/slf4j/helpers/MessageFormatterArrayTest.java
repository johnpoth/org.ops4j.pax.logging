...
public class MessageFormatterArrayTest extends TestCase
{
    ...
    {
        Logger logger = LoggerFactory.getLogger( MessageFormatterArrayTest.class );
        logger.debug("My message with 3 parameters : {}, {}, {}", new Object[]{"1","2","3"});
    ...
    {
        Logger logger = LoggerFactory.getLogger( MessageFormatterArrayTest.class );
        logger.warn("My message with 3 parameters : {}, {}, {}", new Object[]{"1","2","3"});
    ...
    {
        Logger logger = LoggerFactory.getLogger( MessageFormatterArrayTest.class );
        logger.info("My message with 3 parameters : {}, {}, {}", new Object[]{"1","2","3"});
    ...
    {
        Logger logger = LoggerFactory.getLogger( MessageFormatterArrayTest.class );
        logger.error("My message with 3 parameters : {}, {}, {}", new Object[]{"1","2","3"});
